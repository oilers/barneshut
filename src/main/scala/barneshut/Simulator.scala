...
class Simulator(val taskSupport: TaskSupport, val timeStats: TimeStatistics) {
  ...
  def mergeBoundaries(a: Boundaries, b: Boundaries): Boundaries = {
    val mergedBoundries = new Boundaries()
    mergedBoundries.minX = a.minX min b.minX
    mergedBoundries.minY = a.minY min b.minY
    mergedBoundries.maxX = a.maxX max b.maxX
    mergedBoundries.maxY = a.maxY max b.maxY
    mergedBoundries
  }
